...
const Footer = () => {
  ...
  return (
    <div className='bg-[#000300] mx-auto py-16 px-14 justify-center grid lg:grid-cols-3 gap-8 text-gray-300'>
      {/* Left section with brand and social icons */}
      <div>
        <h1 className='w-full text-3xl lg:text-4xl xl:text-4xl items-center  text-[#b1b3b2] flex'>MORDEN <PiImagesSquareFill className='text-3xl lg:text-6xl' /><span className='font-semibold'>GALLERY</span></h1>
        <p className='py-4'>
